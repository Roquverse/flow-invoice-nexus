  ...
  useEffect(() => {
    const fetchData = async () => {
      if (isEditing && quote) {
        ...
        // Generate a new quote number for new quotes
        const newQuoteNumber = await generateQuoteNumber();
        setFormData((prev) => ({ ...prev, quote_number: newQuoteNumber }));
      }
    };
        ...
        <div className="grid grid-cols-1 gap-6 mb-8 w-full">
          ...
          <Card className="w-full" style={{ width: "100%" }}>
            <CardHeader>
              ...
              <CardDescription>Notes and terms for the quote</CardDescription>
            </CardHeader>
